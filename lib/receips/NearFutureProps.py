...
class NearFutureProps(Receipt):
    def __init__(self, game_dir, project_dir):
        ...
        self.source_dir = SourceDir(game_dir, project_dir.joinpath("Source", "NFPropUtils"))
        self.plugins_dir = project_dir.joinpath("GameData", "NearFutureProps", "Plugins")
    ...
    def build(self):
        ...
        rm(self.project_dir.joinpath("GameData", "NearFutureProps", "Versioning"), "*.dll")
    ...
    def install(self):
        ...
        shutil.copytree(self.project_dir.joinpath("GameData", "NearFutureProps"), self.target_dir)
